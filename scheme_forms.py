...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        if(isinstance(expressions.rest, Pair)):
            ...
            env.define(signature, expressions.rest)
        return signature
...
Pair(Pair('lambda', Pair(Pair('x', nil), Pair(Pair('list', Pair('x', Pair(Pair('list', Pair(Pair('quote', Pair('quote', nil)), Pair('x', nil))), nil))), nil))), Pair(Pair('quote', Pair(Pair('lambda', Pair(Pair('x', nil), Pair(Pair('list', Pair('x', Pair(Pair('list', Pair(Pair('quote', Pair('quote', nil)), Pair('x', nil))), nil))), nil))), nil)), nil))
